...
void CRT_setColors(int colorScheme) {
   ...
   if (colorScheme == COLORSCHEME_MONOCHROME) {
      ...
      CRT_colors[PANEL_HEADER_FOCUS] = A_BOLD;
      CRT_colors[PANEL_HEADER_UNFOCUS] = A_BOLD;
      CRT_colors[PANEL_HIGHLIGHT_FOCUS] = A_BOLD;
      CRT_colors[PANEL_HIGHLIGHT_UNFOCUS] = A_DIM;
      ...
      CRT_colors[PANEL_HIGHLIGHT_UNFOCUS] = ColorPair(Red,Black);
      CRT_colors[FAILED_SEARCH] = ColorPair(Red,Blue);
      ...
      CRT_colors[PROCESS_TAG] = ColorPair(Blue,Blue);
      ...
      CRT_colors[LOAD] = ColorPair(Blue,Black);
